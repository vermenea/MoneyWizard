...
import { AddIncomeModalProps } from "../../types/types";
...
export const AddIncomeModal: React.FC<AddIncomeModalProps> = ({
  ...
  const handleAddIncome = () => {
    ...
    onAddIncome({ amount: parseFloat(amount), category, date });
    setAmount("");
    setCategory("");
  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={onClose} style={customStyles}>
      <div className="relative p-4">
        ...
        <h3 className="text-xl font-bold mb-4 text-center">Add Income</h3>
