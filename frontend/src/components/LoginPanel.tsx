        ...
        <form action="">
          <div className="mb-4">
            ...
            <input
              ...
              name="email"
              required
              className="mt-1 block w-full px-3 py-2 border border-purple-400 rounded-md shadow-sm focus:outline-none focus:ring-purple-400 focus:border-purple-400 sm:text-sm"
            />
          </div>
